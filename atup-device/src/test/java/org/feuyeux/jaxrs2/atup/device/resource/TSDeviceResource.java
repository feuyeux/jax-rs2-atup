...
public class TSDeviceResource {
    ...
    public void testFindAll() {
        AtupRequest<String, AtupDevice> request = new AtupRequest<>();
        AtupDevice device = request.rest(AtupRequest.GET, BASE_URI + AtupApi.DEVICE_PATH + "/1", null, null, MediaType.APPLICATION_JSON_TYPE, AtupDevice.class);
        log.info(device);
    }
}
