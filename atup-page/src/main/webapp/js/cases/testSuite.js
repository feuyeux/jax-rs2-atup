function createSuite() {
	...
	rest(HOST + ATUP_CASE_BASE_URI + TEST_SUITE_PATH, POST_METHOD, postData, renderEdit);
}
function updateSuite() {
	...
	rest(HOST + ATUP_CASE_BASE_URI + TEST_SUITE_PATH, PUT_METHOD, putData, renderEdit);
}
function renderEdit(data) {
	jQuery('#resultDiv').html("DONE! id=" + data.suiteId);
